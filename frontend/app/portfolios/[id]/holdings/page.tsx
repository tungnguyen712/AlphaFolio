          ...
          <div className="grid gap-4 sm:grid-cols-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm uppercase focus:outline-none"
              />
            </div>
            <div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-neutral-50">
              {portfolio.holdings.map((h) =>
                editId === h.id ? (
                  <tr key={h.id} className="bg-neutral-50">
                    ...
                    <td className="px-6 py-3">
                      <input
                        ...
                        className="w-24 rounded border border-neutral-300 px-2 py-1 text-right text-sm focus:outline-none"
                      />
                    </td>
                    <td className="px-6 py-3">
                      <input
                        ...
                        className="w-28 rounded border border-neutral-300 px-2 py-1 text-right text-sm focus:outline-none"
                      />
                    </td>
                    <td className="px-6 py-3">
                      <select
                        ...
                        className="rounded border border-neutral-300 bg-white px-2 py-1 text-sm focus:outline-none"
                      >
                        {assetClasses.map((c) => (
                          <option key={c} value={c}>{c}</option>
                        ))}
                  ...
                  <tr key={h.id} className="hover:bg-neutral-50">
                    ...
                    <td className="px-6 py-3 text-xs text-neutral-600">{h.asset_class}</td>
                    <td className="px-6 py-3 text-right">
